/*!
  ...
  https://cdn.jsdelivr.net/npm/@highlightjs/cdn-assets@11.8.0/highlight.min.js
 */
  var hljs = function() {
    "use strict";
    function e(n) {
      ...
      , ne = t => {
        ...
        function f(e, t, i, r) {
            ...
            function d() {
                null != x.subLanguage ? ( () => {
                    ...
                    if ("string" == typeof x.subLanguage) {
                        ...
                        e = E(A, x.subLanguage.length ? x.subLanguage : null);
            ...
            function b(e, n) {
                ...
                A = "") : e.beginScope._multi && (u(e.beginScope, n),
                A = "")),
                x = Object.create(e, {
                    parent: {
                        value: x
            ...
            function _(e) {
                return 0 === x.matcher.regexIndex ? (A += e[0],
                1) : (D = !0,
                0)
            }
            function h(e) {
            ...
            function N(a, r) {
                ...
                if ("begin" === y.type && "end" === r.type && y.index === r.index && "" === o) {
                    if (A += t.slice(r.index, r.index + 1),
                    !s) {
    ...
    function Oe(e) {
        ...
        const _ = [].concat(m, c.contains)
          ...
          , w = {
            match: n.concat(/\b/, (v = [...Ne, "super", "import"],
